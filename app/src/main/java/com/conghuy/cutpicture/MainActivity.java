...
public class MainActivity extends AppCompatActivity
    ...
    void initView() {
        ...
        Log.d(TAG, "_height:" + _height);
        Log.d(TAG, "_width:" + _width);
        _iv = (ImageView) findViewById(R.id._iv);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                final Bitmap bitmap_root = MediaStore.Images.Media.getBitmap(this.getContentResolver(), uri);
                Bitmap bitmap = bitmap_root;
                Log.d(TAG,"getWidth:"+bitmap.getWidth());
                Log.d(TAG,"getHeight:"+bitmap.getHeight());
                float ratio = 1f;
                int _w = _width - 50;
                if (bitmap.getWidth() > _w) {
                    ratio = (bitmap.getWidth() * 1f) / (_w * 1f);
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        Const.storeImage(MainActivity.this, Const.drawOval(bitmap_root));
                    }
                }).start();
            } catch (IOException e) {
                e.printStackTrace();
